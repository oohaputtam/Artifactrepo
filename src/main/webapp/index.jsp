...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .btn-primary:hover { background: var(--accent-dark); border-color: var(--accent-dark); transform: translateY(-2px); box-shadow: 0 8px 24px rgba(224,122,95,0.30); }
    .btn-secondary { background: var(--primary); color: #fff; border-color: var(--primary); }
    .btn-secondary:hover { background: var(--primary-light); border-color: var(--primary-light); transform: translateY(-2px); box-shadow: 0 8px 24px rgba(26,26,46,0.20); }
    ...
    .brand:hover .logo-icon { transform: rotate(-6deg) scale(1.04); }
    .brand .wordmark {
      display: flex; align-items: baseline; gap: 2px;
    }
    .brand .wordmark .nexus {
    ...
    .hero {
      ...
      min-height: 480px; padding: 60px 0;
    ...
    .hero .badge {
      display: inline-block; background: rgba(224,122,95,0.20);
    ...
    .product-card .wish-btn {
      ...
      background: rgba(255,255,255,0.90); display: grid; place-items: center;
    ...
    .deal-wrap .deal-img {
      flex: 0 0 48%; background: var(--surface); min-height: 300px;
    }
    ...
    .deal-wrap .deal-content .tag {
      ...
      letter-spacing: 0.5px; align-self: flex-start; margin-bottom: 12px;
    }
    ...
    /* FOOTER */
    footer {
      margin-top: 16px; padding: 44px 0 28px;
      border-top: 1px solid rgba(26,26,46,0.04);
    }
    .footer-grid {
    ...
    .footer-grid .brand-col p {
      color: var(--muted); font-size: 14px; max-width: 300px; line-height: 1.6;
    }
    ...
    .footer-grid .col h5 {
      font-weight: 700; font-size: 14px; margin-bottom: 12px; color: var(--primary);
    }
    .footer-grid .col ul {
    ...
    @media (max-width:768px) {
      ...
      .brand .logo-icon { width: 34px; height: 34px; font-size: 18px; }
  ...
  <div class="container header-inner">
    <div style="display:flex;align-items:center;gap:12px;">
      ...
      <a class="brand" href="#">
        ...
        <span class="wordmark">
          <span class="nexus">Nexus</span><span class="shop">Shop</span>
        </span>
      </a>
    </div>
